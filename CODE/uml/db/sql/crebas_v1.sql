...
alter table TCAACTIVIDADESD add constraint FK_FK10_TCAACT_TCAACT_ID foreign key (TCAACTIVIDADES_ID)
      references TCAACTIVIDADES (TCAACTIVIDADES_ID) on delete restrict on update restrict;
