...
import { deleteRowClassSchedule } from '@/src/utils/providers/teacher/class-schedule'
          ...
          <button
            ...
            onClick={() =>
              deleteRowClassSchedule(rowClassSchedule.TCAHORARIOSC_ID).then(
                (data) => props.setClassSchedule(data)
              )
            }
          >
            <Image
...
export default function ClassSchedule(props: {
  readonly idMatrix: number
  readonly codPeriod: number
  readonly classSchedule: TCAHORARIOSC[]
}) {
